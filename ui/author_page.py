...
#     """
#     Rendu principal de la page Auteur / Contact / Feedback.
#     """
#     from textwrap import dedent

#     page_header("Auteur & Contact", "À propos de l’application et de son auteur")
...
#                 <p>
#                 Domaines d’intérêt :
#                 chimiométrie, spectroscopie, analyse multivariée,
...
#                     </a>
#                 </p>
#                 <p>Cliquer pour ouvrir votre messagerie.</p>
#             </div>
#             """,
#             unsafe_allow_html=True,
#         )
...
#                     </a>
#                 </p>
#                 <p>Présentation professionnelle et parcours.</p>
#             </div>
#             """,
#             unsafe_allow_html=True,
#         )
...
#                     </a>
#                 </p>
#                 <p>Suggestions, bugs, idées d’amélioration.</p>
#             </div>
#             """,
#             unsafe_allow_html=True,
#         )
...
#         <div class="card">
#             <p>
#             Si vous utilisez l’application, vous pouvez transmettre :
#             </p>
#             <ul>
...
#             </ul>
#             <p>
#             Les retours sont centralisés via le formulaire Google.
#             </p>
#         </div>
#         """,
#         unsafe_allow_html=True,
...
#             <h3>SpectraLyse</h3>
#             <p>
#             SpectraLyse est une application dédiée à l’analyse de données spectrales,
#             conçue pour faciliter le prétraitement, l’exploration et l’interprétation
#             de jeux de données complexes dans un cadre scientifique.
#             </p>
#             <h4>Fonctionnalités disponibles</h4>
#             <ul>
#                 <li>Import et préparation des données</li>
#                 <li>Sélection flexible des variables spectrales</li>
#                 <li>Visualisation interactive des spectres</li>
#                 <li>Prétraitements spectraux</li>
#                 <li>Analyse exploratoire par PCA</li>
...
#         <div class="card">
#             <ul>
#                 <li>Renforcer les outils d’exploration spectrale</li>
#                 <li>Ajouter des analyses multivariées plus avancées</li>
#                 <li>Améliorer l’interprétation et les exports</li>
#                 <li>Développer une expérience utilisateur encore plus fluide</li>
#             </ul>
#         </div>
#         """,
#         unsafe_allow_html=True,
